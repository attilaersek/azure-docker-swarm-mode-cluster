...
var scriptFile = fs.createReadStream('./cloudConfigScript.sh');
var templateFile = fs.createWriteStream('./template.json');
...
streamToString(scriptFile.pipe(zlib.createGzip()).pipe(Base64Encode()), (encodedScript) => {
  template.variables.cloudConfigScript = encodedScript;
